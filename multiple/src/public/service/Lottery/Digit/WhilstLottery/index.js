...
export class JLWhilstLottery {
    ...
    constructor(_type) {
        let key = Object.entries(JLWhilstLottery.PlayTypeEnum).find(m => m[1] == _type)[0];

        let type = JLWhilstLottery.PlayTypeEnum[key.replace('_Compound', '')];
